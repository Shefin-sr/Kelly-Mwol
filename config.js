...
module.exports = {
    ...
    SESSION: process.env.KELLY_CODE === undefined ? '' : process.env.KELLY_CODE,
    ...
    KELLY_MWOL: process.env.KELLY_MWOL === undefined ? 'Hello' : process.env.AMAL_SER,
    KELLY_MOL: process.env.KELLY_MOL === undefined ? 'Hii' : process.env.AMAL_S,   
